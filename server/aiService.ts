  ...
  static async validateCrypto(coinId: number): Promise<any> {
    try {
      ...
      const mockValidation = {
        ...
        socialAnalysis: 'Strong social media presence with positive sentiment across major platforms. Increasing mentions and engagement.',
        technicalAnalysis: 'Technical indicators show bullish momentum with strong support levels. RSI indicates healthy buying pressure.',
        whaleAnalysis: 'Large wallet movements suggest accumulation phase. Institutional interest remains high.',
        overallSignal: 'BUY',
        overallConfidence: Math.floor(Math.random() * 20) + 80,
        recommendation: 'Based on comprehensive analysis, this crypto shows strong potential for upward movement. All indicators align for a positive outlook.'
      };
      ...
      const mockRadarData = [
        {
          ...
          signal: 'BUY',
          confidence: 85,
          reasoning: 'Large whale accumulation detected over the past 24 hours. $50M+ moved to cold storage.',
          coin: { symbol: 'BTC', name: 'Bitcoin', price: '45000.00', change24h: '2.5', changePercent24h: '2.5' }
        },
        {
          id: 2,
          coinId: 2,
          ...
          signal: 'WATCH',
          confidence: 72,
          reasoning: 'Social media sentiment turning positive. Trending on Twitter with 500K+ mentions.',
          coin: { symbol: 'ETH', name: 'Ethereum', price: '2800.00', change24h: '1.8', changePercent24h: '1.8' }
        },
        {
          id: 3,
          coinId: 3,
          ...
          signal: 'BUY',
          confidence: 78,
          reasoning: 'Breaking out of resistance level. Technical indicators show strong bullish momentum.',
          coin: { symbol: 'SOL', name: 'Solana', price: '95.00', change24h: '5.2', changePercent24h: '5.2' }
        }
      ];

      return type ? mockRadarData.filter(item => item.radarType === type) : mockRadarData;
    } catch (error) {
